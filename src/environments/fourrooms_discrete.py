...
class FourRoomsGridWorld(gym.Env):
    ...
    def reset(self, *, seed=None, options=None):
        ...
        if start is None and "start_pos" in options:
            start = options["start_pos"]
...
class FourRoomsGoalWrapper(gym.Wrapper):
    def __init__(self, env, goal_position=(20, 20), goal_reward=1.0, step_reward=0.0, slip_prob=0.0):
        super().__init__(env)
